...
def pipeline(query: str, method: str = 'cs', n_contexts: int = 5,
             chatgpt_prompt="As a teacher's assistant for a machine learning course, your role is to assist students "
                            "by answering their questions. You have over 20 years of experience and are regarded as "
                            "one of the best in the field. You will be presented with a question and given several "
                            "context paragraphs from the lecture notes. Your task is to answer the question as "
                            "comprehensively and accurately as possible  Please thoroughly read the context paragraph "
                            "and determine if any information is relevant to answer the question. Your answer should "
                            "be based on your own high level of expertise and only use the information in the context "
                            "paragraph if any is relevant. In case the question does not have any direct reference in "
                            "the lecture notes, please state that the specific information is not mentioned in the "
                            "lecture notes and proceed to answer the question based on your knowledge. You may give a "
    ...
    :param chatgpt_prompt: A prompt which is used to generate answers from the chatgpt model
